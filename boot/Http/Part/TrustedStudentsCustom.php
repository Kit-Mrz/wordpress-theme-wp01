...
class TrustedStudentsCustom
{
    ...
    public function getEndPost() : array
    {
        ...
        return PostRepository::getInstance()->queryPrograms($this->postIds);
    }
}

$trustedStudentsCustom = new TrustedStudentsCustom($args ?? []);
...
<section class="visit-one fix">
    ...
    <div class="tailor-details">
        <?php foreach ($trustedStudentsCustom->getEndPost() as $item): ?>
